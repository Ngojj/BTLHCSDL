...
exports.user = (0, mysql_core_1.mysqlTable)("user", {
    ...
    firstName: (0, mysql_core_1.varchar)("firstName", { length: 255 }).notNull(),
    lastName: (0, mysql_core_1.varchar)("lastName", { length: 255 }).notNull(),
    username: (0, mysql_core_1.varchar)("username", { length: 64 }).notNull().unique(),
    password: (0, mysql_core_1.varchar)("password", { length: 64 }).notNull(),
    role: (0, mysql_core_1.varchar)("role", { length: 20 }).notNull(),
    bankName: (0, mysql_core_1.varchar)("bankName", { length: 20 }).notNull(),
    bankAccount: (0, mysql_core_1.varchar)("bankAccount", { length: 255 }).notNull(),
});
/* ============= STUDENT ============= */
exports.student = (0, mysql_core_1.mysqlTable)("student", {
    userId: (0, mysql_core_1.int)("userId").notNull().references(() => exports.user.id, { onDelete: "cascade" }).primaryKey(),
...
exports.course = (0, mysql_core_1.mysqlTable)("course", {
    ...
    teacherId: (0, mysql_core_1.int)("teacherId").notNull().references(() => exports.teacher.userId, { onDelete: "cascade" }),
    creTime: (0, mysql_core_1.date)("creTime").notNull().default((0, drizzle_orm_1.sql) `(CURRENT_DATE())`),
...
exports.courseTopic = (0, mysql_core_1.mysqlTable)("courseTopic", {
    courseId: (0, mysql_core_1.int)("courseId").notNull().references(() => exports.course.id, { onDelete: "cascade" }),
...
exports.quiz = (0, mysql_core_1.mysqlTable)("quiz", {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    name: (0, mysql_core_1.varchar)("name", { length: 512 }).notNull(),
    state: (0, mysql_core_1.varchar)("state", { length: 20 }).notNull().default("opened"),
    attempt: (0, mysql_core_1.int)("attempt").notNull().default(1),
    duration: (0, mysql_core_1.int)("duration").notNull().default(10),
    teacherId: (0, mysql_core_1.int)("teacherId").notNull().references(() => exports.teacher.userId, { onDelete: "cascade" }),
    sectionId: (0, mysql_core_1.int)("sectionId").notNull().references(() => exports.section.id, { onDelete: "cascade" }),
    creTime: (0, mysql_core_1.date)("creTime").notNull().default((0, drizzle_orm_1.sql) `(CURRENT_DATE())`),
});
/* ============= QUESTION ============= */
exports.question = (0, mysql_core_1.mysqlTable)("question", {
    id: (0, mysql_core_1.int)("id").notNull(),
    quizId: (0, mysql_core_1.int)("quizId").notNull().references(() => exports.quiz.id, { onDelete: "cascade" }),
    type: (0, mysql_core_1.varchar)("type", { length: 50 }).notNull().default("multiple choice"),
...
exports.option = (0, mysql_core_1.mysqlTable)("option", {
    questionId: (0, mysql_core_1.int)("questionId").notNull().references(() => exports.question.id, { onDelete: "cascade" }),
    option: (0, mysql_core_1.varchar)("option", { length: 528 }).notNull(),
}, (table) => ({
    pk: (0, mysql_core_1.primaryKey)({
...
exports.roadCertification = (0, mysql_core_1.mysqlTable)("roadCertification", {
    ...
    issueDate: (0, mysql_core_1.date)("issueDate").notNull().default((0, drizzle_orm_1.sql) `(CURRENT_DATE())`),
    courseId: (0, mysql_core_1.int)("courseId").notNull().references(() => exports.course.id, { onDelete: "cascade" }),
    studentId: (0, mysql_core_1.int)("studentId").notNull().references(() => exports.student.userId, { onDelete: "cascade" }),
});
/* ============= REQUIRE COURSE ============= */
exports.requireCourse = (0, mysql_core_1.mysqlTable)("requireCourse", {
    courseId: (0, mysql_core_1.int)("courseId").notNull().references(() => exports.course.id, { onDelete: "cascade" }),
    rCourseId: (0, mysql_core_1.int)("rCourseId").notNull().references(() => exports.course.id, { onDelete: "cascade" }),
}, (table) => ({
    pk: (0, mysql_core_1.primaryKey)({
...
exports.join = (0, mysql_core_1.mysqlTable)("join", {
    ...
    dateStart: (0, mysql_core_1.date)("dateStart").notNull().default((0, drizzle_orm_1.sql) `(CURRENT_DATE())`),
...
exports.dO = (0, mysql_core_1.mysqlTable)("dO", {
    ...
    attemptOrder: (0, mysql_core_1.int)("attemptOrder").notNull().default(1),
}, (table) => ({
    pk: (0, mysql_core_1.primaryKey)({
...
exports.lecture = (0, mysql_core_1.mysqlTable)("lecture", {
    id: (0, mysql_core_1.int)("id").autoincrement().primaryKey(),
    name: (0, mysql_core_1.varchar)("name", { length: 255 }).notNull(),
    state: (0, mysql_core_1.varchar)("state", { length: 20 }).notNull().default("uncomplete"),
...
exports.interact = (0, mysql_core_1.mysqlTable)("interact", {
    lectureId: (0, mysql_core_1.int)("lectureId").notNull().references(() => exports.lecture.id, { onDelete: "cascade" }),
    studentId: (0, mysql_core_1.int)("studentId").notNull().references(() => exports.student.userId, { onDelete: "cascade" }),
}, (table) => ({
    pk: (0, mysql_core_1.primaryKey)({
...
exports.includeCourse = (0, mysql_core_1.mysqlTable)("includeCourse", {
    rmId: (0, mysql_core_1.int)("rmId").notNull().references(() => exports.roadMap.id, { onDelete: "cascade" }),
    courseId: (0, mysql_core_1.int)("courseId").notNull().references(() => exports.course.id, { onDelete: "cascade" }),
