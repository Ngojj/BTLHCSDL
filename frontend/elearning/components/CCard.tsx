...
const CCard = () => {
    return (
        <div className=" flex flex-col bg-white rounded-md border-black border">
            <img className="w-full h-full rounded-t" src="https://images.unsplash.com/photo-1607799279861-4dd421887fb3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D" width={100} height={100} alt="Course cover" />
            <div className="p-4">
